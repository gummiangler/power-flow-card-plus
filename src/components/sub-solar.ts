...
export const subSolarElement = (main: PowerFlowCardPlus, config: PowerFlowCardPlusConfig, solar: Solar, multipleIndividuals: boolean) => {
  return html`${solar.entity && solar.solar_second_entity
    ? html`
        <div class="subSolarContainer">
          <div class="row">${renderSubSolarRow(main, config, solar, multipleIndividuals)}</div>
          <div class="subSolarFlowContainer">
            <div class="halfFlexBox"></div>
            <div class="fullFlexBox">${renderFlowContainer(config, solar, multipleIndividuals)}</div>
            <div class="halfFlexBox"></div>
...
const renderSubSolarRow = (main: PowerFlowCardPlus, config: PowerFlowCardPlusConfig, solar: Solar, multipleIndividuals: boolean) => {
  return html`
    <div class="halfFlexBox"></div>
